...
# General Tips 4
Otherwise, X\_k in R^{exists status length\*n}, x in {2, 1}^n, with negated logic, Not And\_k And\_m Xor\_n x\_{m,n,k}\*x\_n == 1 + Pi\_k det diag(X\_k x) = 1+2^Sum\_k Sum\_l \<x\_{k,l}, x\>

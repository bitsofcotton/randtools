...
In occasion someone expanding the field or some of the information surface expanding case, we cannot avoid the condition constant edge forever exists because of such a flag condition with the #f so re-selecting f-tree made us enough beat with jammers but with them, we face again because #f and flag condition even inner of the past f condition.
